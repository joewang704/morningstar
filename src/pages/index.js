    ...
    <Container>
      <Navbar />
        <div className="relative text-white">
          ...
          <button style={{ fontWeight: 300 }} className="fade-in-text absolute top-12 left-8 lg:left-20 text-lg uppercase py-4 px-4 hover:underline">View Our Programs {'>'}{'>'}</button>
          <BGWrapper
